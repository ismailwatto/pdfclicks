...
final class PdfToWord extends Component
{
    use WithFileUploads;
    ...
    public function convertToWord(): void
    {
        $this->validate();
        ...
        try {
            ...
            // Use CloudConvert directly for PDF-to-Word conversion
            $cloudConvert = new CloudConvertAction();
            $result = $cloudConvert->convert($this->uploadedFile, 'docx');
    ...
    public function downloadFile()
    {
        ...
        return response()->download($this->convertedFile, 'converted-document.docx');
    }
    ...
    private function updateProgress(array $status): void
    {
        switch ($status['status']) {
            ...
            case 'processing':
                ...
                $this->conversionStatus = 'Converting PDF to Word...';
                break;
            case 'finished':
    ...
    private function handleConversionSuccess(array $result): void
    {
        ...
        $this->successMessage = 'PDF successfully converted to Word document!';
