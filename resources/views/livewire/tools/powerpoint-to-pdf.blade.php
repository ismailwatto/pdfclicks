        ...
        <div class="relative">
            ...
            >
                <div class="text-center">
                    <i class="fas fa-file-powerpoint text-4xl text-orange-400 mb-2"></i>
                    ...
                    <p class="text-xs text-gray-500">PPT, PPTX up to 20MB</p>
                </div>
            </label>
        </div>
        @error('uploadedFile') 
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Your presentation has been successfully converted</p>
                </div>
                <button 
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-lg shadow-xl">
                <div class="text-center">
                    ...
                    <p class="text-gray-700">Converting your presentation...</p>
